...
config.keymaps = {
  globalkeys = {
    show_hotkeys = {
      ...
      key = "s",
      press = function()
        require("naughty").notify({ text = "dsafas" })
    ...
    increase_numbe_of_master = {
      mod = { modkey, 'Shift' },
      key = 'h',
      press = function() awful.tag.incnmaster(1, nil, true) end,
    ...
    increase_number_of_columns = {
      mod = { modkey, 'Control' },
      key = 'h',
      press = function() awful.tag.incncol(1, nil, true) end,
    ...
    select_next = {
      mod = { modkey },
      key = 'space',
      press = function() awful.layout.inc(1) end,
    ...
    powermenu = {
      mod = { modkey },
      key = 'q',
      press = function() require("modules.powermenu").bar() end,
    ...
    terminal = {
      mod = { modkey },
      key = 'Return',
      press = function() awful.spawn(config.app.terminal.cmd) end,
    ...
    flameshot = {
      mod = { modkey, 'Shift' },
      key = 'p',
      press = function() awful.spawn(config.app.flameshot.cmd) end,
      description = 'Rofi',
      group = 'Launcher',
    },
    rofi = {
      mod = { modkey },
      key = 'd',
      press = function() awful.spawn(config.app.rofi.cmd) end,
      description = 'Rofi',
      group = 'Launcher',
    },
  },
  clientkeys = {
    ...
    move_to_master = {
      mod = { modkey, 'Control' },
      key = 'Return',
      press = function(c) c:swap(awful.client.getmaster()) end,
...
config.mousemap = {
  ...
  taglist_mouse = {
    view_only = {
      mod = {},
      button = 1,
      press = function(t) t:view_only() end
    },
    move_to_tag = {
      mod = { modkey },
      button = 1,
    ...
    viewnext = {
      mod = {},
      button = 4,
      press = function(t) awful.tag.viewprev(t.screen) end
    },
    viewprev = {
      mod = {},
      button = 5,
      press = function(t) awful.tag.viewnext(t.screen) end
    },
  },
}
